...
contract OracleDeployment is Script {
    function run() external {
        ...
        console.log("Base Token deployed at address: ", address(token1));
        console.log("Quote Token deployed at address: ", address(token2));
        ...
        console.log("OracleSwap contract deployed at address: ", address(swap));
